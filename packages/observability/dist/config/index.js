...
exports.createDerivedConfig = exports.serviceConfigs = exports.createObservabilityConfigSchema = void 0;
const zod_1 = require("zod");
// Standard Observability Configuration Schema
// This template should be used by all microservices for consistency
const createObservabilityConfigSchema = (serviceName, defaultPort, defaultMetricsPort) => {
    return zod_1.z.object({
        // Application
        NODE_ENV: zod_1.z.enum(['development', 'staging', 'production']).default('development'),
        PORT: zod_1.z.coerce.number().min(1).max(65535).default(defaultPort),
        HOST: zod_1.z.string().default('0.0.0.0'),
        // Service Identity
        SERVICE_NAME: zod_1.z.string().default(serviceName),
        ...
        METRICS_PORT: zod_1.z.coerce.number().min(1).max(65535).default(defaultMetricsPort),
        ...
        RATE_LIMIT_REDIS_PREFIX: zod_1.z.string().default(`rl:${serviceName}:`),
...
exports.createObservabilityConfigSchema = createObservabilityConfigSchema;
