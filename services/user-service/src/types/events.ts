// Local type definitions based on contracts
// These will be synchronized with the main contracts package
...
// Additional producer-specific types
...
// Event sourcing types for business events
