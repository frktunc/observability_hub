...
const configSchema = zod_1.z.object({
    ...
    DATABASE_URL: zod_1.z.string().default('postgresql://order_service_user:order_service_password@order_service_db:5432/order_service_db'),
    DATABASE_HOST: zod_1.z.string().default('order_service_db'),
    DATABASE_PORT: zod_1.z.coerce.number().default(5432),
    DATABASE_NAME: zod_1.z.string().default('order_service_db'),
    DATABASE_USER: zod_1.z.string().default('order_service_user'),
    DATABASE_PASSWORD: zod_1.z.string().default('order_service_password'),
    ...
    METRICS_PORT: zod_1.z.coerce.number().min(1).max(65535).default(9091),
