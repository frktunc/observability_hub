...
const configSchema = z.object({
  ...
  PORT: z.coerce.number().min(1).max(65535).default(8082),
  ...
  REDIS_DB: z.coerce.number().default(2), // Different DB: user-service=1, product-service=2
  ...
  RATE_LIMIT_MAX_REQUESTS: z.coerce.number().default(100), // Redis ile daha güçlü rate limiting
  RATE_LIMIT_REDIS_ENABLED: z.coerce.boolean().default(true),
  RATE_LIMIT_REDIS_PREFIX: z.string().default('rl:product-service:'),
